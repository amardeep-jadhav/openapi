          ...
          <v-row class="fill-height no-gutters">
            ...
            <v-col cols="12" class="col-md-4 col-lg-4 col-xl-4 pt-0 pb-0 mt-4 clsEndPointListSection">
              <hds-card 
                ...
                centered
              >
              <LeftNavApi :tags="tags" :selectedEntry="selectedEntry" @onSelectEntry="select"></LeftNavApi>
            </hds-card>
            </v-col>
          </v-row>
        </v-container>
...
.v-navigation-drawer--floating.v-navigation-drawer--mini-variant {
  width: 58px !important;
}
.v-navigation-drawer--mini-variant .v-expansion-panel-header {
  display: none;
}
/* .v-navigation-drawer--floating i.v-icon.notranslate {
  position: absolute; 
  left: 50%;
  margin-left: -12px; 
  min-width: 50px;
...
.v-navigation-drawer--floating .v-avatar.v-list-item__avatar {
  display: none;
}
...
.v-expansion-panel.d-flex.down-arrow.v-expansion-panel--active.v-item--active,
.v-item--active i,
.v-item--active button.v-expansion-panel-header--active {
...
body > .v-application .theme--light .clsEndPointSection .v-list-item__content > *{
  color: #fff!important;
}
...
.v-navigation-drawer .v-expansion-panel-content__wrap {
    padding: 0!important;
}

.v-application table td p {
    margin-bottom: 0px;
}
.p-fixed {
  position:fixed;
