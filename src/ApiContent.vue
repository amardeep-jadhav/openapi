    ...
    <v-row>
      <v-col cols="12" sm="12" md="12">
        ...
        <!-- <div
          ...
          <div class="pt-2">
            <h2 class="text-h2-alt stone-gray--text pb-4">
            Disclaimer
            </h2>
            <p class="text-h5 d-inline stone-gray--text">
              Aerial Access utilizes synthetic data. Synthetic data is information that's artificially manufactured rather than generated by real-world events. Synthetic data is created algorithmically, and it is used as a stand-in for test datasets of production or operational data.
            </p>
          </div>
      </v-col>
    </v-row>
